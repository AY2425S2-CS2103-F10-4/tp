...
with(this){return _c('p',[_v("TutorProxMax is adapted from AddressBook Level 3: "),_c('a',{attrs:{"href":"https://github.com/nus-cs2103-AY2425S2/tp"}},[_v("https://github.com/nus-cs2103-AY2425S2/tp")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"list-command"}},[_v("List Command"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#list-command","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The sequence diagram below illustrates how the list command is processed when the user enters a command such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list t/Math")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list tt/Monday")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list tt/mon")]),_v(" .\nThis command allows users to either")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("list all student via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")])]),_v(" "),_c('li',[_v("list all students with a specific subject specified after "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("t/")]),_v(".\n"),_c('ul',[_c('li',[_v("example: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list t/math")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list t/Science")]),_v(".")])])]),_v(" "),_c('li',[_v("list all students with a tuition time on a specific day specified after prefix "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("tt/")]),_v(".\n"),_c('ul',[_c('li',[_v("example: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list tt/Monday")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list tt/mon")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list tt/Monday, 1000-1200")])])])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("LogicManager parses the user input into a ListCommand.")])]),_v(" "),_c('li',[_c('p',[_v("ListCommand is executed via the Model.")])]),_v(" "),_c('li',[_c('p',[_v("The model updates its filtered list using the predicate provided by ListCommand.")])]),_v(" "),_c('li',[_c('p',[_v("The UI is automatically refreshed based on the updated filtered list.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" feature allows tutors to organize the student list based on specific fields such as name, address, email, phone, subject, or tuition timing. This improves usability by enabling tutors to view student data in a desired order, which is especially useful when managing many students.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" command is implemented using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SortCommand")]),_v(" class, which accepts a field keyword (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("name")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("phone")]),_v(") and applies the corresponding comparator to the address book list. The command then updates the filtered person list with the sorted result.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The sorting logic is encapsulated in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonComparators")]),_v(" utility class, which contains static comparators for each sortable field. This separation of concerns makes it easier to maintain and extend.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("When the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" command is executed:")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The user input is parsed into a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SortCommand")]),_v(" with a specific comparator.")]),_v(" "),_c('li',[_v("The model’s "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sortPersonList")]),_v(" method is called with this comparator.")]),_v(" "),_c('li',[_v("The list displayed to the user is updated to reflect the new sorted order.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("private tutors who need to manage a significant number of contacts and lesson details")]),_v(" "),_c('li',[_v("private tutors who conduct weekly lessons to each student in the day")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")]),_v(" "),_c('li',[_v("the context is "),_c('strong',[_v("Singapore")]),_v(" where the form of communication is mainly in English")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("TutorProMax")]),_v(" is an all-in-one desktop assistant built specifically for tutors.\nWhether they are juggling multiple students, managing lesson time, or students' subjects, TutorProMax keeps everything organised in one place.\nWith intuitive features like scheduling, reminders, and offline support, it empowers tutors to focus more on teaching and less on administrative work. Say goodbye to cluttered spreadsheets and scattered notes — TutorProMax helps tutors run their tutoring business like pros.")]),_v(" "),_c('li',[_v("It is especially suited for tutors who can type fast and prefer a "),_c('strong',[_v("Command Line Interface (CLI)")]),_v(" over graphical interfaces, allowing for faster, more efficient workflows.")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("see usage instructions")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use the App")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add a student")]),_v(" "),_c('td',[_v("keep track of all students and can refer to their contact details when I need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete a student")]),_v(" "),_c('td',[_v("remove outdated or irrelevant student contact details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("view all students' contact details")]),_v(" "),_c('td',[_v("easily access students’ information and retrieve their contact details efficiently")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("find a student by his/her name")]),_v(" "),_c('td',[_v("locate details of students without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("edit a contact details")]),_v(" "),_c('td',[_v("update new information without having to go through the process of delete and add")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("list lessons by date")]),_v(" "),_c('td',[_v("view all lessons scheduled on a particular day")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("list students by subject")]),_v(" "),_c('td',[_v("view all students with a filtered subject")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("sort students according to a field I specified")]),_v(" "),_c('td',[_v("view all student a in particular order for to find them more easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("Press "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("↑")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("↓")]),_v(" keys after entering commands")]),_v(" "),_c('td',[_v("navigate the previous commands more easily especially if i want to add, delete, edit multiple students")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook (TutorProMax)")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user (tutor)")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a specific person in the list")])]),_v(" "),_c('li',[_c('p',[_v("TutorProMax adds the student")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The student already exists in the list")])]),_v(" "),_c('li',[_c('p',[_v("1a1. TutorProMax shows an error message")]),_v(" "),_c('ul',[_c('li',[_v("Use case resumes at step 2")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons")])]),_v(" "),_c('li',[_c('p',[_v("TutorProMax shows a list of persons")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the list")])]),_v(" "),_c('li',[_c('p',[_v("TutorProMax deletes the person")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. TutorProMax shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Find a student by his/her name")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to search for a student by name")])]),_v(" "),_c('li',[_c('p',[_v("TutorProMax searches for the student in the list")])]),_v(" "),_c('li',[_c('p',[_v("TutorProMax displays the matching student(s)")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. No matching student found")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. TutorProMax displays a message indicating that no student matches the given name")]),_v(" "),_c('p',[_v("Use case ends")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: List persons")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons")])]),_v(" "),_c('li',[_c('p',[_v("TutorProMax lists all students in the address book.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. User specifies a tag keyword (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list t/math")]),_v(").\n"),_c('ul',[_c('li',[_v("1a1. TutorProMax lists students whose tags contain the specified keyword.\nUse case ends.")])])]),_v(" "),_c('li',[_v("1b. User specifies a tuition day keyword (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list tt/monday")]),_v(").\n"),_c('ul',[_c('li',[_v("1b1. TutorProMax lists students whose tuition time contains the specified day."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_v("1c. User specifies both tag and tuition time (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list tt/monday t/math")]),_v(").\n"),_c('ul',[_c('li',[_v("1c1. TutorProMax lists students who match both the tuition day and tag.\nUse case ends.")])])]),_v(" "),_c('li',[_v("1d. No students match the given filter(s)\n"),_c('ul',[_c('li',[_v("1d1. TutorProMax shows a message indicating no matching students found."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_v("1e. User inputs an invalid format (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list tt/mondae")]),_v(")\n"),_c('ul',[_c('li',[_v("1e1. TutorProMax shows an error message indicating invalid input."),_c('br'),_v("\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: Sort students")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to sort students by a specified field and order.")])]),_v(" "),_c('li',[_c('p',[_v("TutorProMax sorts and displays the student list accordingly.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User specifies a valid field and order (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort name asc")]),_v(")")]),_v(" "),_c('ul',[_c('li',[_v("1a1. TutorProMax sorts the address book using the given field and order."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. User specifies an invalid field (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort grade asc")]),_v(")")]),_v(" "),_c('ul',[_c('li',[_v("1b1. TutorProMax shows an error message:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Invalid sort field. Valid fields: name, phone, email, address, tuition, tag")]),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1c. User omits sort order (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort name")]),_v(")")]),_v(" "),_c('ul',[_c('li',[_v("1c1. TutorProMax shows an error message indicating invalid command format."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1d. User inputs an invalid sort order (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort name upwards")]),_v(")")]),_v(" "),_c('ul',[_c('li',[_v("1d1. TutorProMax shows an error message indicating sort order must be "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("asc")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("desc")]),_v("."),_c('br'),_v("\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to edit a specific student by specifying their index in the list.")])]),_v(" "),_c('li',[_c('p',[_v("TutorProMax updates the student’s details with the provided fields.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The specified index is invalid (e.g. index does not exist in the current list)")]),_v(" "),_c('ul',[_c('li',[_v("1a1. TutorProMax shows an error message indicating the index is invalid."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. No fields are specified for editing (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 2")]),_v(")")]),_v(" "),_c('ul',[_c('li',[_v("1b1. TutorProMax shows an error message indicating that at least one field must be provided."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1c. User clears all tags by specifying "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("t/")]),_v(" without any tags")]),_v(" "),_c('ul',[_c('li',[_v("1c1. TutorProMax removes all tags from the student."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1d. User specifies invalid values (e.g. email without '@', invalid phone number, etc.)")]),_v(" "),_c('ul',[_c('li',[_v("1d1. TutorProMax shows an appropriate validation error message."),_c('br'),_v("\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Tutor")]),_v(": Private tutor who conducts weekly one to one, face-to-face lessons with his/her students.")]),_v(" "),_c('li',[_c('strong',[_v("Tag")]),_v(": Tags are used to classify students according to "),_c('strong',[_v("subjects")]),_v(".")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Below are the manual test cases for verifying each feature of "),_c('strong',[_v("TutorProMax")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('blockquote',[_c('p',[_c('strong',[_v("Note:")]),_v(" These are starting points. Testers are encouraged to perform exploratory testing for more thorough coverage.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Download the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v(".jar")]),_v(" file and copy it into an empty folder.")]),_v(" "),_c('li',[_v("Open a terminal and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cd")]),_v(" into the folder.")]),_v(" "),_c('li',[_v("Run: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar tutorpromax.jar")])]),_v(" "),_c('li',[_c('strong',[_v("Expected:")]),_v(" GUI opens with sample data.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Resize and move the window. Close the app.")]),_v(" "),_c('li',[_v("Re-launch it using the same command.")]),_v(" "),_c('li',[_c('strong',[_v("Expected:")]),_v(" Previous window size and position is retained.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Command:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/98765432 e/john@example.com a/123 Clementi Rd tt/Monday, 1000-1200 t/Math t/Science")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Expected:")]),_v(" John Doe is added to the list with all the details correctly saved and displayed.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"invalid-cases-to-test"}},[_v("Invalid Cases to Test:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#invalid-cases-to-test","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Missing mandatory fields:\n"),_c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add p/98765432")])]),_v(" "),_c('li',[_v("Error Message: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Invalid command format!  add: Adds a person to the address book. Parameters: n/NAME p/PHONE e/EMAIL a/ADDRESS tt/TUITION_TIME [t/TAG]... Example: add n/John Doe p/98765432 e/johnd@example.com a/311, Clementi Ave 2, #02-25 tt/Monday, 1400-1600 t/Math t/Science")]),_v(".")])])]),_v(" "),_c('li',[_v("Invalid phone number: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Jane p/abc123")]),_v(" → Same error message as above.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Commands to Test:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")])])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list t/Math")])])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list tt/Monday")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")])]),_v(" "),_c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(": Shows all contacts.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list t/Math")]),_v(": Filters only those with Math tag (case-sensitive).")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list tt/Monday")]),_v(": Filters only those with tuition on Monday.")])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"invalid-cases-to-test-2"}},[_v("Invalid Cases to Test:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#invalid-cases-to-test-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Invalid day format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list tt/mondayyy")]),_v(" "),_c('ul',[_c('li',[_v("Error Message: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Invalid day entered. Please use a valid day like 'monday' or 'mon' (case-insensitive). list with no prefix behind list all contacts. list with prefix list all contacts with the keyword specified in rhe prefix. Parameters: [field, keyword] There are 2 fields available: t/[subject] or tt/[tuition time (day)]. Example: list t/Math Example: list tt/Monday")])])])]),_v(" "),_c('li',[_v("Empty field with prefix: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list t/")]),_v(" "),_c('ul',[_c('li',[_v("Error Message: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Please enter field and keyword! list with no prefix behind list all contacts. list with prefix list all contacts with the keyword specified in rhe prefix. Parameters: [field, keyword] There are 2 fields available: t/[subject] or tt/[tuition time (day)]. Example: list t/Math Example: list tt/Monday")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"finding-persons-by-name"}},[_v("Finding Persons by Name"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#finding-persons-by-name","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Command:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find John")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Expected:")]),_v(" All persons with \"John\" in their name (case-insensitive) are listed.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"additional-cases"}},[_v("Additional Cases:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#additional-cases","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find John Alex")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find jOhN")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" (no input) → Should show error.\n"),_c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Invalid command format! find: Finds all persons whose names contain any of the specified keywords (case-insensitive) and displays them as a list with index numbers. Parameters: KEYWORD [MORE_KEYWORDS]... Example: find alice bob charlie")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Command:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 p/91234567 e/new@example.com")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Expected:")]),_v(" Updates the phone and email of person at index 1.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"additional-cases-2"}},[_v("Additional Cases:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#additional-cases-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 2 n/Alice t/")]),_v(" → Clears tags.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 5")]),_v(" (no fields) → Error message.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 0")]),_v(" or index out of bounds → Error message.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Command:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 2")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Expected:")]),_v(" The 2nd person in the current list is removed.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"additional-cases-3"}},[_v("Additional Cases:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#additional-cases-3","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(" → Error.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete abc")]),_v(" → Error.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 100")]),_v(" → Error if out of bounds.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"sorting"}},[_v("Sorting"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#sorting","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Commands to Test:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort name asc")])])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort tuition desc")])])]),_v(" "),_c('li',[_c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort by email asc")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Expected:")]),_v(" List is sorted as specified.")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"invalid-case"}},[_v("Invalid Case:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#invalid-case","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort by banana desc")]),_v(" → Error: Invalid sort field.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Expected:")]),_v(" All contacts are removed.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"edge-case"}},[_v("Edge Case:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#edge-case","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear 123")]),_v(" → Should still work and clear everything.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Expected:")]),_v(" Application closes.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Expected:")]),_v(" Help window opens with list of commands.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Press "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("↑")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("↓")]),_v(" keys after entering commands.")]),_v(" "),_c('li',[_c('strong',[_v("Expected:")]),_v(" Cycles through previously entered commands.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"saving-and-editing-data"}},[_v("Saving and Editing Data"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#saving-and-editing-data","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"1-data-persistence"}},[_v("1. Data Persistence"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#1-data-persistence","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Add/edit/delete a person.")]),_v(" "),_c('li',[_v("Close and reopen the app.")]),_v(" "),_c('li',[_c('strong',[_v("Expected:")]),_v(" All data changes are saved.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"2-editing-the-json-file"}},[_v("2. Editing the JSON File"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#2-editing-the-json-file","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Tue, 8 Apr 2025, 12:46:46 GMT+8]")])])])}
}];
